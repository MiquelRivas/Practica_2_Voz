...
Para realizarlo, nos compararemos estas respuestas con las la pregunta: "Ha tengut problemes de veu importants i que li han dificultat la feina al llarg del curs 2022-2023?".
...
El resultado del test inferencial, cuadra con el gráfico anterior, ya que este da a entender que el mejor hábito para la voz es no seguir ninguna rutina. 
Aún así, existe la posibilidad de que, debido a la formulación de las preguntas, no se recopile toda la información de forma adecuada para esclarecer de manera correcta la pregunta, como por ejemplo, la razón por la que se empieza una rutina, como hemos explicado anteriormente.